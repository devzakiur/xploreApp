...
class Question extends MY_Controller
{
	...
	public function view()
	{
		if ($_POST) {
			...
			$config['total_rows']  = $this->question->get_all_question("", "", $search_key, $created_by, $filter_by, $category_id, $subject_id, $section_id, $topic_id, $batch_id, $year, $sorting, true);
			...
			$this->data['all_question'] = $this->question->get_all_question(QUESTION_PER_PAGE, $offset, $search_key, $created_by, $filter_by, $category_id, $subject_id, $section_id, $topic_id, $batch_id, $year, $sorting);
	...
	public function user_details_view()
	{
		if ($_GET) {
			$user_id = $this->input->get("user_id");
			$result = $this->question->get_single("users", array("id" => $user_id));
			$html = $this->load->view("show_user_details", $result, true);
			echo json_encode($html);
			exit;
		}
	}
