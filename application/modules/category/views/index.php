...
<?php echo $this->session->flashdata("msg"); ?>
        <?php  if(hasPermission("category",ADD)): ?>
            <?php if(isset($add)): ?>
                <div class="row">
                    <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" placeholder="Category Name" class="form-control" required id="name" >
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-border panel-info">
                            ...
                            <div class="panel-body">
                                <!-- <form id="find"> -->
                                <?php echo form_open("category/edit/".$single->id); ?>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="name">Name</label><small class="req"> *</small>
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Subject Show</th>
											<?php endif; ?>
...
<script>
    $(document).ready(function(){
			...
			function last_order_position() {
				  $.get("<?php echo base_url() ?>ajax/get_last_order_position?table_name=category", function(data, status){
						$("#position").val(data);
				  });
			}
        $("#category_add").on("submit",function(e){
            e.preventDefault();
            var url="<?php echo base_url() ?>category/add";
            $.ajax({
                url:url,
                type:"post",
                dataType:"json",
        ...
        {
            $.ajax({
                url:"<?php echo base_url() ?>category/view",
                type:"get",
                dataType:"json",
                data:{"user":"s"},
                success:function(data){
        ...
        $("#datatable").on("click",'.inputswitch',function(){
            var value=0;
            var id='';
            var url="<?php echo site_url("category/subject_show"); ?>";
            if($(this).is(":checked"))
            {
                value=1;
            }
