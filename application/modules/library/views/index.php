<div class="content">
    <div class="container">
								...
								<div class="panel-body">
									...
									<?php echo form_open_multipart("library/edit/".$single['id']); ?>
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													<label for="picture">Cover Image</label>(<small>JPG,PNG  MAX SIZE 500 KB</small>)
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-border panel-info">
					 <div class="panel-heading"><h3 class="panel-title">Lbrary View</h3></div>
                    <div class="panel-body">
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
