                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-border panel-info">
							 <div class="panel-heading"><h3 class="panel-title">Manage Section</h3></div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-border panel-info">
                            ...
                            <div class="panel-body">
                                <!-- <form id="find"> -->
                                <?php echo form_open("section/edit/".$single->id); ?>
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label for="name">Name</label><small class="req"> *</small>
...
<script>
    $(document).ready(function(){
			...
			function last_order_position() {
				  $.get("<?php echo base_url() ?>ajax/get_last_order_position?table_name=section", function(data, status){
						$("#position").val(data);
				  });
			}
        $("#section_add").on("submit",function(e){
            e.preventDefault();
            var url="<?php echo base_url() ?>section/add";
            $.ajax({
                url:url,
                type:"post",
                dataType:"json",
