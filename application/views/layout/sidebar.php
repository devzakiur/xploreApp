  	...
  	<div class="sidebar-inner slimscrollleft">
  		...
  		<div id="sidebar-menu">
  			<ul>
  				...
  				<?php endif; ?>
  				<?php if (hasActive("reports") && hasPermission("reports", VIEW)) : ?>
  					<li class="has_sub">
  						<a href="#" class="waves-effect <?php echo set_Topmenu("reports"); ?>"><i class="fa  fa-pie-chart"></i><span>Reports </span><span class="pull-right"><i class="md md-add"></i></span></a>
  						<ul class="list-unstyled">
  							<?php if (hasPermission("reports", VIEW)) : ?>
  								<li class="<?php echo set_Submenu("reports"); ?>"><a href="<?php echo site_url("reports"); ?>">Model Test</a></li>
  							<?php endif; ?>
  							<?php if (hasPermission("game_challenge", VIEW)) : ?>
  								<li class="<?php echo set_Submenu("game_challenge"); ?>"><a href="<?php echo site_url("reports/game_challenge"); ?>">Game Challenge</a></li>
  							<?php endif; ?>
  						</ul>
  					</li>
  				<?php endif; ?>
